...
|%[nb1.nb2]s|nb1 is the min lenght, nb2 is the max if string's lenght < nb1 is greater than nb, it will add **spaces** at the **beginning** of the string, <br> if string's lenght > nb2 it will be cropped down to nb2|
